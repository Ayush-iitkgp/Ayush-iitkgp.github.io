...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/blog", "Blog"),
        ("https://drive.google.com/file/d/1Vz5m3MWiulh-_VJVASmGYiiwbK8ifE8q/view?usp=sharing", "Resume"),
        ...
        #("https://www.linkedin.com/in/ayushiitkgp", "LinkedIn"),
...
PAGES = (
    ...
    #("stories/*.docx", "stories", "story.tmpl"),
